 ...
 *  shared proxy down, network failure, user's own key missing/invalid),
 *  shows the error's own message with a tappable action straight into
 *  Settings → AI Food Scan. Anything else (e.g. a plain validation Error)
 *  just shows its message, same as before this existed. */
